...
for page in range(1,7):
    ...
    for problem in problems:
        ...
        if 'ShowProblem' in problem['href']:
            ...
            data['problem_title_link'] = f"[{problem_title}](https://judge.tcirc.tw{problem_link})"
            
            data_list.append(data)
    
    # print(data_list[0])
    df = pd.DataFrame(data_list)
    df.to_excel('AP325_problems.xlsx', index = False, engine = "openpyxl")